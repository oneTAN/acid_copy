...
for item in boss_battle_multi_pickup_event_schedule[pu_number]:
    ...
    if (start_time_son == start_time) and (end_time_son == end_time):
        ...
        boss_layer.paste(whole_boss_img_copy, (217+8, 500+y1), whole_boss_img_copy)
        draw_text.text((620, max(500 + int((y1+y2)/2)-3-70, 470+y1)), whole_boss_name, font=ft37, fill=text_color)
